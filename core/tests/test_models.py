...
class GetFilePathTestCase(TestCase):
    def setUp(self):
        self.filename = f'{uuid.uuid4()}.png'  # criando arquivo para ver se tem a mesma estrutura
...
class CargoTestCase(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.cargo), self.cargo.cargo)  # para comparar um lado com o outro
